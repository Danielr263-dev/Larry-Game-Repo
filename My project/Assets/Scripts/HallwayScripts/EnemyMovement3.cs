...
public class EnemyMovement3 : MonoBehaviour
{
    ...
    private Transform[] waypoints; // Stores waypoints A, B, C
    ...
    void Start()
    {
        ...
        waypoints = new Transform[] { pointA.transform, pointB.transform, pointC.transform };
    ...
    IEnumerator PauseAtWaypoint()
    {
        ...
        // Reverse direction if we reach either end (A or C)
